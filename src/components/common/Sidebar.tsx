...
const menuItems: MenuItem[] = [
  ...
  { id: '6', label: 'Deliveries', icon: 'local-shipping', screen: 'Deliveries' },
  { id: '7', label: 'Analytics', icon: 'trending-up', screen: 'Analytics' },
  { id: '8', label: 'Settings', icon: 'settings', screen: 'Settings' },
];
